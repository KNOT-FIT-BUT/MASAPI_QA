...
# Lint as: python3
#
# Original was adapted for this project.
...
def evaluate_predictions(references, predictions, is_regex):
    """Calculates and returns metrics."""

    correct = 0
    for a, p in zip(references, predictions):
        correct += int(is_correct(answers=a, prediction=p, is_regex=is_regex))
